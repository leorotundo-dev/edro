    ...
    parameters: {
      repair_type: {
        ...
        description: 'Tipo de reparo a executar.',
          enum: ['auto_repair', 'process_webhook_retries', 'flush_trello_outbox', 'revive_dead_trello_outbox', 'ensure_trello_webhooks', 'reconcile_trello_dark_boards', 'recover_jarvis_background_jobs', 'renew_google_watches', 'run_gmail_fallback', 'refresh_client_intelligence', 'refresh_jarvis_alerts'],
        },
