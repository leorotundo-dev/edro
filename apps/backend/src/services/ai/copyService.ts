...
export async function generateCollaborativeCopy(params: {
  ...
  const buildCreativePrompt = (analysisOutput: string) => [
    ...
    'Legenda: [caption completo para postar nas redes sociais. Estilo conversacional, 3 a 5 paragrafos. Inclua hashtags relevantes ao final.]',
    'CTA: [chamada para acao]',
    '',
    'OPCAO 2:',
    '(mesmo formato acima)',
    '',
    'NAO use JSON, NAO use blocos de codigo, NAO use markdown. Apenas texto simples.',
    '',
  ...
  const buildReviewPrompt = (analysisOutput: string, creativeOutput: string) => [
    ...
    '',
    'REGRAS ABSOLUTAS:',
    '1. Retorne TODAS as opcoes recebidas — nunca elimine, junte ou reduza o numero de opcoes.',
    '2. Se uma opcao estiver boa (7/10 ou mais), mantenha-a com ajustes minimos.',
    '3. Se uma opcao estiver ruim (abaixo de 7/10), reescreva-a completamente — mas mantenha-a como opcao separada.',
    ...
    'Legenda: [caption final, sem comentarios]',
    'CTA: [chamada para acao, sem comentarios]',
    '',
    'OPCAO 2:',
    '(mesmo formato)',
    '',
