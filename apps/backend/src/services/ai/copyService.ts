...
export async function generateCollaborativeCopy(params: {
  ...
  const buildReviewPrompt = (analysisOutput: string, creativeOutput: string) => [
    ...
    'Revise cada opcao de copy abaixo com rigor editorial, considerando:',
    ...
    '',
    'Para cada copy: se a qualidade for menor que 7/10, REESCREVA com melhorias.',
    'Ordene do melhor para o pior.',
    '',
    'FORMATO OBRIGATORIO — preserve EXATAMENTE esta estrutura:',
    'OPCAO 1:',
    'Arte - Titulo: [...]',
    'Arte - Corpo: [...]',
    'Legenda: [...]',
