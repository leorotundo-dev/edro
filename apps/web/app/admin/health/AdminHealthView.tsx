...
import {
  IconHeartbeat, IconAlertTriangle, IconRefresh, IconSearch,
  IconChevronRight,
...
function AdminHealthContent({ embedded = false }: { embedded?: boolean }) {
  ...
  const content = (
    <Box>
      ...
      {!embedded ? <AdminSubmenu value="saude" /> : null}
  ...
  return <AppShell title="System Admin">{content}</AppShell>;
}

export function EmbeddedAdminHealthView() {
  return <AdminHealthContent embedded />;
}
