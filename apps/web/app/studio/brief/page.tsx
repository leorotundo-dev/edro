...
export default function Page({ searchParams }: { searchParams?: StudioSearchParams }) {
  ...
  const src = query
    ? `/ux/edro_creative_studio_step1/code.html?${query}`
    : '/ux/edro_creative_studio_step1/code.html';

  return <StudioFrame title="Creative Studio Brief" src={src} stepLabel="Etapa 1 de 6" />;
}
