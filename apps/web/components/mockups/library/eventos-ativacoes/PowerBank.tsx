...
interface PowerBankProps {
  productImage?: string;
  brandLogo?: string;
  brandColor?: string;
}

export const PowerBank: React.FC<PowerBankProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-[200px] h-[250px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
