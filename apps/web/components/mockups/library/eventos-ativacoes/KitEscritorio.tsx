...
interface KitEscritorioProps {
  productImage?: string;
  brandLogo?: string;
  brandColor?: string;
}

export const KitEscritorio: React.FC<KitEscritorioProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-full max-w-[500px] h-[300px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
