...
export const BandeiraVento: React.FC<BandeiraVentoProps> = ({
  ...
  return (
    <div 
      className="relative w-[200px] h-[600px] rounded-lg overflow-hidden shadow-2xl border-4"
