...
export const PortaFolder: React.FC<PortaFolderProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-[250px] h-[400px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
