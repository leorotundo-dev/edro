...
interface SinalizacaoBanheiroProps {
  text?: string;
...
export const SinalizacaoBanheiro: React.FC<SinalizacaoBanheiroProps> = ({
  ...
  return (
    <div 
      className="relative w-[225px] h-[225px] rounded-lg overflow-hidden shadow-md border-2"
