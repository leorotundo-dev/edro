...
interface MochilaProps {
  productImage?: string;
  brandLogo?: string;
  brandColor?: string;
}

export const Mochila: React.FC<MochilaProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-[300px] h-[450px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
