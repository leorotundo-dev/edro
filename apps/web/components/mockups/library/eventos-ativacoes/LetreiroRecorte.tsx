...
interface LetreiroRecorteProps {
  brandName?: string;
  brandLogo?: string;
  tagline?: string;
...
export const LetreiroRecorte: React.FC<LetreiroRecorteProps> = ({
  ...
  return (
    <div 
      className="relative w-full max-w-[600px] h-[200px] rounded-lg overflow-hidden shadow-2xl border-4"
