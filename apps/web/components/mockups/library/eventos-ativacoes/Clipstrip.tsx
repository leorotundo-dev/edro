...
export const Clipstrip: React.FC<ClipstripProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-[150px] h-[500px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
