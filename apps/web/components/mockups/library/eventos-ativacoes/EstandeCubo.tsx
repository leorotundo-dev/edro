...
export const EstandeCubo: React.FC<EstandeCuboProps> = ({
  brandLogo = '',
  ...
  return (
    <div className="relative w-[300px] h-[300px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-xl">
