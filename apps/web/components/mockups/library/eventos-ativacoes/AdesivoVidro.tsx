...
export const AdesivoVidro: React.FC<AdesivoVidroProps> = ({
  ...
  return (
    <div 
      className="relative w-[350px] h-[450px] rounded-lg overflow-hidden shadow-md border-2"
