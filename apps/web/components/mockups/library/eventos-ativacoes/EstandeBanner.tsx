...
export const EstandeBanner: React.FC<EstandeBannerProps> = ({
  brandLogo = '',
  ...
  return (
    <div className="relative w-[255px] h-[600px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-xl">
