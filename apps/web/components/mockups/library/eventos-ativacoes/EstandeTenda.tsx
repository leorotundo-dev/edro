...
export const EstandeTenda: React.FC<EstandeTendaProps> = ({
  brandLogo = '',
  ...
  return (
    <div className="relative w-full max-w-[500px] h-[400px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-xl">
