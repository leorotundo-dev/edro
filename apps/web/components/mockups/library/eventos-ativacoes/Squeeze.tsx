...
export const Squeeze: React.FC<SqueezeProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-[180px] h-[350px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
