...
export const FaixaGondola: React.FC<FaixaGondolaProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-full max-w-[600px] h-[150px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
