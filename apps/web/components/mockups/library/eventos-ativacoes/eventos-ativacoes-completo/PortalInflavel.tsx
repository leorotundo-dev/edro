...
export const PortalInflavel: React.FC<PortalInflavelProps> = ({
  backgroundImage = '',
  ...
  return (
    <div className="relative w-full max-w-[500px] h-[600px] bg-gray-900 rounded-lg overflow-hidden shadow-2xl">
