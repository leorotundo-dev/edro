...
interface EcobagProps {
  productImage?: string;
  brandLogo?: string;
  brandColor?: string;
}

export const Ecobag: React.FC<EcobagProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-[320px] h-[400px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
