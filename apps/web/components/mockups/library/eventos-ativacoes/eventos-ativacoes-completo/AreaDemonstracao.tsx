...
interface AreaDemonstracaoProps {
...
export const AreaDemonstracao: React.FC<AreaDemonstracaoProps> = ({
  backgroundImage = '',
  ...
  return (
    <div className="relative w-full max-w-[700px] h-[400px] bg-gray-900 rounded-lg overflow-hidden shadow-2xl">
