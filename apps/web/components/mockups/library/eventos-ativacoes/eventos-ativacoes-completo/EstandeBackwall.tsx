...
interface EstandeBackwallProps {
  brandLogo?: string;
  brandName?: string;
  tagline?: string;
...
export const EstandeBackwall: React.FC<EstandeBackwallProps> = ({
  brandLogo = '',
  ...
  return (
    <div className="relative w-full max-w-[600px] h-[400px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-xl">
