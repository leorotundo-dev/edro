...
interface ChaveiroProps {
  productImage?: string;
  brandLogo?: string;
  brandColor?: string;
}

export const Chaveiro: React.FC<ChaveiroProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-[150px] h-[200px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
