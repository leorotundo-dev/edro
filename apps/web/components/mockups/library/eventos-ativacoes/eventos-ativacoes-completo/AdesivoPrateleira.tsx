...
interface AdesivoPrateleiraProps {
  displayImage?: string;
  productName?: string;
  brandLogo?: string;
  promoText?: string;
...
export const AdesivoPrateleira: React.FC<AdesivoPrateleiraProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-full max-w-[500px] h-[100px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
