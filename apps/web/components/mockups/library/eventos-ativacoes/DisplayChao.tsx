...
export const DisplayChao: React.FC<DisplayChaoProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-[350px] h-[500px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
