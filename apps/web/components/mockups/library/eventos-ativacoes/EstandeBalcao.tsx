...
export const EstandeBalcao: React.FC<EstandeBalcaoProps> = ({
  brandLogo = '',
  ...
  return (
    <div className="relative w-[400px] h-[360px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-xl">
