...
export const EstandeIlha: React.FC<EstandeIlhaProps> = ({
  brandLogo = '',
  ...
  return (
    <div className="relative w-full max-w-[600px] h-[500px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-xl">
