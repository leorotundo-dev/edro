...
export const EstandeGrande: React.FC<EstandeGrandeProps> = ({
  brandLogo = '',
  ...
  return (
    <div className="relative w-full max-w-[700px] h-[500px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-xl">
