...
export const PontaGondola: React.FC<PontaGondolaProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-full max-w-[500px] h-[600px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
