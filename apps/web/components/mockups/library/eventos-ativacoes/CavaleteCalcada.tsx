...
interface CavaleteCalcadaProps {
  brandName?: string;
  brandLogo?: string;
  tagline?: string;
...
export const CavaleteCalcada: React.FC<CavaleteCalcadaProps> = ({
  ...
  return (
    <div 
      className="relative w-[350px] h-[500px] rounded-lg overflow-hidden shadow-2xl border-4"
