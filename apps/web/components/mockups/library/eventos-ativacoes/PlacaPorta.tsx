...
export const PlacaPorta: React.FC<PlacaPortaProps> = ({
  ...
  return (
    <div 
      className="relative w-[320px] h-[80px] rounded-lg overflow-hidden shadow-md border-2"
