...
export const PlacaParede: React.FC<PlacaParedeProps> = ({
  ...
  return (
    <div 
      className="relative w-[400px] h-[300px] rounded-lg overflow-hidden shadow-md border-2"
