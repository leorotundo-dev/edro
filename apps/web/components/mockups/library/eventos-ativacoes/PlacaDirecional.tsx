...
interface PlacaDirecionalProps {
  text?: string;
...
export const PlacaDirecional: React.FC<PlacaDirecionalProps> = ({
  ...
  return (
    <div 
      className="relative w-full max-w-[500px] h-[150px] rounded-lg overflow-hidden shadow-md border-2"
