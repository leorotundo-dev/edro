...
export const DisplayBalcao: React.FC<DisplayBalcaoProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-[300px] h-[400px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
