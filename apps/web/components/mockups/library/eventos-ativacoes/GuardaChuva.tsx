...
interface GuardaChuvaProps {
  productImage?: string;
  brandLogo?: string;
  brandColor?: string;
}

export const GuardaChuva: React.FC<GuardaChuvaProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-[350px] h-[400px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
