...
export const TelaoProjecao: React.FC<TelaoProjecaoProps> = ({
  backgroundImage = '',
  ...
  return (
    <div className="relative w-full max-w-[700px] aspect-video bg-gray-900 rounded-lg overflow-hidden shadow-2xl">
