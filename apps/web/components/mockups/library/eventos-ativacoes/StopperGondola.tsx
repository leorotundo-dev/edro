...
export const StopperGondola: React.FC<StopperGondolaProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-[200px] h-[300px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
