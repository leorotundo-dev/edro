...
export const FaixaFachada: React.FC<FaixaFachadaProps> = ({
  ...
  return (
    <div 
      className="relative w-full max-w-[800px] h-[200px] rounded-lg overflow-hidden shadow-2xl border-4"
