...
export const Camiseta: React.FC<CamisetaProps> = ({
  productImage = '',
  brandLogo = '',
  brandColor = '#10b981',
}) => {
  return (
    <div className="relative w-[350px] h-[450px] bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-md">
