...
export const PlacaHorario: React.FC<PlacaHorarioProps> = ({
  ...
  return (
    <div 
      className="relative w-[350px] h-[400px] rounded-lg overflow-hidden shadow-2xl border-4"
