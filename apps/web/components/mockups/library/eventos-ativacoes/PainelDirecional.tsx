...
interface PainelDirecionalProps {
...
export const PainelDirecional: React.FC<PainelDirecionalProps> = ({
  backgroundImage = '',
  ...
  return (
    <div className="relative w-[400px] h-[500px] bg-gray-900 rounded-lg overflow-hidden shadow-2xl">
