...
interface EstruturaSuspensaProps {
...
export const EstruturaSuspensa: React.FC<EstruturaSuspensaProps> = ({
  backgroundImage = '',
  ...
  return (
    <div className="relative w-full max-w-[600px] h-[300px] bg-gray-900 rounded-lg overflow-hidden shadow-2xl">
