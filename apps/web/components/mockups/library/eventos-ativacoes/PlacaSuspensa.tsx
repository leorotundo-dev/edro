...
export const PlacaSuspensa: React.FC<PlacaSuspensaProps> = ({
  ...
  return (
    <div 
      className="relative w-full max-w-[500px] h-[200px] rounded-lg overflow-hidden shadow-md border-2"
