...
export const CheckStand: React.FC<CheckStandProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-[300px] h-[350px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
