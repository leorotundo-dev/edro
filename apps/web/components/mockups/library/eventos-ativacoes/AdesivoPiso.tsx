...
export const AdesivoPiso: React.FC<AdesivoPisoProps> = ({
  displayImage = '',
  ...
  return (
    <div className="relative w-[400px] h-[400px] bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
