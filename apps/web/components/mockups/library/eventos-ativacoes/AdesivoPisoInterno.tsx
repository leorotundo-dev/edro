...
interface AdesivoPisoInternoProps {
  text?: string;
...
export const AdesivoPisoInterno: React.FC<AdesivoPisoInternoProps> = ({
  ...
  return (
    <div 
      className="relative w-[400px] h-[400px] rounded-lg overflow-hidden shadow-md border-2"
