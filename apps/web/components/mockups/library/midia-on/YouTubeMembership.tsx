...
export const YouTubeMembership: React.FC<YouTubeMembershipProps> = ({
  ...
  const resolvedTierName = title ?? headline ?? name ?? tierName;
  ...
  return (
    <div className="w-full max-w-[400px] bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      <div className="bg-red-600 p-4 text-white text-center">
        <h3 className="text-xl font-bold mb-1">{resolvedTierName}</h3>
        ...
        <div className="space-y-2 mb-6">
          {benefits.map((benefit, i) => (
            <div key={i} className="flex items-start gap-2">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-600 flex-shrink-0"><polyline points="20 6 9 17 4 12"/></svg>
