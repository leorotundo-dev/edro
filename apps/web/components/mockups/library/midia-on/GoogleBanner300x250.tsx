...
export const GoogleBanner300x250: React.FC<GoogleBanner300x250Props> = ({
  ...
  return (
    <div className="w-[300px] h-[250px] bg-white border border-gray-300 shadow-sm overflow-hidden flex flex-col">
      ...
      <div className="p-3">
        <div className="flex items-start gap-2 mb-2">
          ...
          <div className="flex-1 min-w-0">
            <h4 className="font-semibold text-xs text-gray-900 line-clamp-2">{headline}</h4>
            <p className="text-[10px] text-gray-600 mt-0.5 line-clamp-1">{description}</p>
          </div>
        </div>
        <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-1.5 rounded text-xs">
          {ctaText}
        </button>
      </div>
    </div>
