...
export function ResponsiveShell({
  ...
  return (
    <div className={cn('min-h-screen bg-slate-50', bodyClassName)}>
      ...
      <aside
        className={cn(
          'fixed top-16 bottom-0 z-40 w-72 bg-white shadow-lg transition-transform duration-300 lg:top-0 lg:bottom-0 lg:shadow-none',
      ...
      <main
        className={cn(
          'px-4 pb-24 pt-20 transition-[margin] lg:px-10 lg:pb-12 lg:pt-8',
          contentClassName
        )}
        style={isDesktop ? { marginLeft: SIDEBAR_WIDTH } : undefined}
      >
        {children}
      </main>
