...
the system already applies the approved edro style reference image automatically. make the final avatar feel like it belongs to the exact same turma, cast, and polished 3d toy world as that reference while still preserving the real person. stylization must simplify the real face, not replace it. keep the rendering matte, clean, understated, and softly lit. allow a gentle Pixar toy feeling in the sculpted forms and readable silhouette, but never baby-like, never chibi, never like a different person, and never a generic commercial mascot.
