...
class SeleconScraper extends BaseScraper {
  constructor() {
    super('Selecon', 'https://selecon.org.br');
  }
  ...
  async scrape() {
    ...
    try {
      const feedUrl = `${this.baseUrl}/concursos/feed/`;
      ...
      const configuredLimit = parseInt(
        process.env.SELECON_LIMIT || process.env.SCRAPER_LIMIT || '10',
        10
      );
