...
import {
  IconCoinFilled, IconClockFilled, IconRosetteDiscountCheckFilled, IconTruckFilled
  , IconRefresh, IconXboxXFilled, IconSearch, IconFilter, IconSettings, IconDownload,
  IconArrowsSort, IconArrowDown, IconArrowUp, IconPencil, IconTrash, IconX
...
export default function OrderTable() {
  ...
  const statsData = [
    ...
    },
    {
      ...
      label: "Pending",
      icon: (
        <IconClockFilled color={theme.palette.success.main} />
      ),
    ...
    },
    {
      ...
      label: "Cancelled",
      icon: (
        <IconXboxXFilled color={theme.palette.error.main} />
      ),
      bgcolor: "error.light",
    },
  ];
