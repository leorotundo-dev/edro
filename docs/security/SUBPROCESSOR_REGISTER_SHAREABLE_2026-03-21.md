...
| Recall.ai | reunioes, gravacoes e transcricoes | sim | indireto | metadata de reuniao, participantes, gravacoes, transcricoes | sim | DPA nao publicado no site — solicitar por email ao suporte (privacy@recall.ai ou support@recall.ai). PENDENTE envio. |
